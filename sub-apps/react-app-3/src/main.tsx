...
//   appName: 'react-app-3',
//   basename: window.__POWERED_BY_QIANKUN__ ? '/order-management' : '/',
//   debug: process.env.NODE_ENV === 'development',
//   enableParameterReceiving: true,
//   enableCrossAppNavigation: true,
//   onNavigationReceived: (event) => {
//     console.log('[ReactApp3] Navigation event received:', event);
//   },
//   onParameterReceived: (event) => {
//     console.log('[ReactApp3] Parameters received:', event);
//   },
//   onRouteChange: (event) => {
//     console.log('[ReactApp3] Route changed:', event);
//   }
// });
